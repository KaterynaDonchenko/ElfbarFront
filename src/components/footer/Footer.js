        ...
        <footer className="footer">
                ...
                <div className="footer__center-block">
                    <nav className="footer__menu">
                        ...
                        <ul className="footer__menu-list">
                            ...
                            <li className="footer__menu-item">
                                <NavLink to={`/catalog/filter?orderby=all&page=1`} onClick={goToCatalog}>Каталог</NavLink>
                            </li>
                            <li className="footer__menu-item">
                                <NavLink to='/question'>Відповіді на питання</NavLink>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div className="footer__sosial">
                        ...
                        <div className="footer__sosial-wrapper">
                            ...
                            <div className="footer__sosial-instagram">
                                <a href="https://instagram.com/s.olodkiypar?igshid=MzRlODBiNWFlZA==">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="footer__bottom">
                ...
                <div className="footer__privacy">
                    <NavLink to='/policy'>Угода користувача</NavLink>
                </div>
            </div>
        </footer>
    )
